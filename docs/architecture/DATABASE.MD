...
| learning_skill_id | bigint FK(user_skills) — nullable (Phase 7: one-way exchange support) |
| message           | text                                                |
